        ...
        <section style={{ padding: '100px 24px', backgroundColor: 'white' }}>
            <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px', alignItems: 'start' }}>
                    <div>
                        <div style={{ width: '120px', height: '120px', borderRadius: '50%', backgroundColor: '#e8f2ee', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '48px', fontWeight: '700', color: '#4A7A68', marginBottom: '24px' }}>
                            S
                        </div>
                        <h3 style={{ fontSize: '24px', fontWeight: '700', color: '#1a2e28', marginBottom: '4px' }}>
                            Sahil Inamdar
                        </h3>
                        <p style={{ fontSize: '14px', color: '#4A7A68', fontWeight: '600', marginBottom: '20px' }}>
                            Founder & CEO
                        </p>
                        ...
                        <p style={{ fontSize: '15px', color: '#4a6b62', lineHeight: '1.8', marginBottom: '20px' }}>
                            The science is clear. Sleep, movement, morning light, screen discipline — these daily habits are the highest-leverage interventions known to prevent the exact conditions I spent my career studying. Most people know this. Almost nobody does it consistently.
                        </p>
                        <p style={{ fontSize: '15px', color: '#4a6b62', lineHeight: '1.8', marginBottom: '20px' }}>
                        ...
                        <p style={{ fontSize: '15px', color: '#4a6b62', lineHeight: '1.8', marginBottom: '0', fontStyle: 'italic', borderLeft: '3px solid #C96A52', paddingLeft: '16px' }}>
                    ...
                    <div>
                            ...
                            {credentials.map(function (cred) {
                                return (
                                    <div key={cred.stat} style={{ backgroundColor: '#F4F7F5', borderRadius: '12px', padding: '20px', textAlign: 'center' }}>
                                        <div style={{ fontSize: '28px', fontWeight: '700', color: '#4A7A68', marginBottom: '4px' }}>{cred.stat}</div>
                        ...
                        {publications.map(function (pub) {
                            return (
                                <div key={pub.title} style={{ borderLeft: '3px solid #4A7A68', paddingLeft: '16px', marginBottom: '20px' }}>
                        ...
                        <div style={{ backgroundColor: '#F4F7F5', borderRadius: '12px', padding: '24px', marginTop: '8px' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                {['Patent holder', 'Book chapter author', 'Guest editor for peer-reviewed journals', '100+ conference presentations'].map(function (item) {
                                    return (
                                        <div key={item} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                            <div style={{ width: '7px', height: '7px', borderRadius: '50%', backgroundColor: '#4A7A68', flexShrink: 0 }}></div>
                                            <span style={{ fontSize: '14px', color: '#4a6b62' }}>{item}</span>
                                        </div>
                                    )
                                })}
                            </div>
