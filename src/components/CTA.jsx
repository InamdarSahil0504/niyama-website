    ...
    return (
        <section style={{ padding: '100px 24px', backgroundColor: '#4A7A68' }}>
            <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                <img src="/niyama-icon-nobg.svg" alt="Niyama Life" style={{ height: '64px', width: 'auto', display: 'block', margin: '0 auto 24px' }} />
                ...
                <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.7)', maxWidth: '480px', margin: '0 auto 48px', lineHeight: '1.7' }}>
                    {isIndia
                        ...
                        : 'Start free. No credit card required. Get real rewards for your first 3 months just for showing up.'}
                </p>
                <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <a href={isIndia ? 'mailto:info@niyamalife.com' : 'https://app.niyamalife.com'} target={isIndia ? '_self' : '_blank'} rel="noopener noreferrer" style={{ backgroundColor: '#C96A52', color: 'white', fontWeight: '700', fontSize: '16px', padding: '16px 40px', borderRadius: '30px', textDecoration: 'none' }}>
                        {isIndia ? 'Get in Touch' : 'Start Free'}
                    </a>
