...
export default function Terms() {
    const sections = [
        ...
        { title: '2. Description of service', content: 'Niyama Life is a behaviour change platform that allows users to track a fixed framework of 10 daily habits — 3 core habits (Wake Consistency, Sleep Duration, and Steps) and 7 library habits (Screen Time, No Phone after 10:30pm, Stand Consistency, Morning Sunlight, No Late Food after 8pm, Recovery Practice, and Meditation) — accumulate points, and redeem those points as financial rewards in the form of gift cards, subject to subscription tier eligibility. The service is live. Subscriptions are active and rewards are paid monthly to eligible subscribers.' },
