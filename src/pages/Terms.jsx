...
export default function Terms() {
    const sections = [
        ...
        { title: '2. Description of service', content: 'Niyama Life is a behaviour change platform that allows users to build a personalised framework of 9 daily habits, accumulate points, and redeem those points as financial rewards in the form of gift cards, subject to subscription tier eligibility. The service is currently in Beta. During Beta, subscriptions and rewards are not yet active. This will change at the Beta 2 launch.' },
